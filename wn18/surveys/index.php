  ...
  <tbody>
	...
	{# process each row
     ...
     echo '
        ...
        <tr>
          <td><a href="survey_view.php?id=2">' . dbOut($row['Title']) . '</a></td>
          <td>' . dbOut($row['AdminName']) . '</td>
          <td>' . dbOut($row['DateAdded']) . '</td>
        </tr>
        
        <tr>
          <td><a href="survey_view.php?id=3">' . dbOut($row['Title']) . '</a></td>
          <td>' . dbOut($row['AdminName']) . '</td>
          <td>' . dbOut($row['DateAdded']) . '</td>
        </tr>
        
        <tr>
          <td><a href="survey_view.php?id=4">' . dbOut($row['Title']) . '</a></td>
          <td>' . dbOut($row['AdminName']) . '</td>
          <td>' . dbOut($row['DateAdded']) . '</td>
        </tr>
        '; 
